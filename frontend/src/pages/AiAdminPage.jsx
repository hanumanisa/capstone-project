                    ...
                    <section className="bg-white rounded-2xl p-4 shadow-sm border border-[#D0E8F8]">
                        <div className="flex justify-between items-center mb-3">
                            <h3 className="text-[#1E5084] text-xs font-bold flex items-center gap-2">
                                <AlertTriangle className="w-4 h-4 text-[#E74C3C]" /> Suggestions
                            </h3>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-[#D0E8F8] flex flex-col overflow-hidden">
                    ...
                    <div className="flex-1 p-5 overflow-y-auto space-y-4 custom-scrollbar">
                        {chatMessages.map((msg, idx) => (
                            <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                <div
                                    className={`chat-bubble max-w-[85%] px-4 py-3 rounded-2xl text-[13px] leading-relaxed shadow-xs word-wrap break-word ${msg.role === 'user'
                    ...
                    <div className="p-4 bg-white border-t border-[#D6EFFF] flex gap-2">
                        ...
                        <button
                            ...
                            className={`px-6 rounded-xl transition-all text-white shadow-sm flex items-center justify-center gap-2 ${!adminSession || adminLoading
