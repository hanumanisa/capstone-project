...
const AiAdminPage = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-[#D6EFFF] font-['Lexend'] overflow-hidden">
            <header className="bg-[#1E5084] h-15 flex items-center px-5 justify-between shadow-lg shrink-0">
                <div className="flex items-center space-x-4">
                    ...
                    <div className="text-white text-sm font-semibold tracking-wide">⚙️ Integrated L&D System — Admin POV</div>
                </div>
                <div className="bg-[#E74C3C] text-white px-3 py-1 rounded-full text-[10px] font-bold tracking-widest">SYSTEM ADMINISTRATOR</div>
            </header>
            ...
            <main className="flex-1 p-4 grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-4 overflow-hidden">
                ...
                <div className="flex flex-col gap-4 overflow-y-auto pr-1 custom-scrollbar">
                    ...
                    <section className="bg-white rounded-2xl p-4 shadow-sm border border-[#D0E8F8]">
                        <div className="flex justify-between items-center mb-3">
                            <h3 className="text-[#1E5084] text-xs font-bold flex items-center gap-2"><span>⚠️</span> Unanswered Log</h3>
                            <div className="flex items-center gap-2">
                                <span className="text-[9px] text-gray-400 italic">Terbaru</span>
                                <button 
                                    onClick={fetchData} 
                                    className="text-[#1E70B9] hover:rotate-180 transition-transform duration-500"
                                    title="Refresh Data"
                                >
                        ...
                        <div className="bg-[#F0FAF4] border border-[#B7E4CB] rounded-xl p-3">
                            <div className="text-[#1D6F42] text-[11px] font-bold flex items-center gap-2 mb-3"><span>📊</span> Export to Excel</div>
                            <div className="grid grid-cols-2 gap-2 mb-3">
                                <div className="space-y-1">
                                    <label className="text-[9px] font-bold text-gray-400 uppercase">Dari</label>
                                ...
                                <div className="space-y-1">
                                    <label className="text-[9px] font-bold text-gray-400 uppercase">Sampai</label>
                            ...
                            <button onClick={exportToExcel} className="w-full bg-[#1D6F42] text-white text-[11px] font-bold py-2 rounded-lg hover:bg-[#155230] transition-colors">⬇️ Export .xlsx</button>
                    ...
                    {/* AI Settings */}
                    <section className="bg-white rounded-2xl p-4 shadow-sm border border-[#D0E8F8]">
                        <h3 className="text-[#1E5084] text-xs font-bold mb-3">⚙️ AI Settings</h3>
                        <div className="bg-[#F0FDF4] border-l-4 border-[#25D366] rounded-r-lg p-2 text-[10px] text-gray-500 mb-3 leading-relaxed">
                            📌 Nomor WhatsApp untuk tombol <strong>"Hubungi Admin"</strong> di tampilan user.
                        </div>
                        <div className="flex items-center gap-2 mb-3">
                            <div className="bg-[#075e54] text-white px-3 py-2 rounded-lg text-xs font-bold">📱 +</div>
                            <input 
                                type="tel" 
                                value={waNumber}
                                onChange={(e) => setWaNumber(e.target.value.replace(/\D/g, ''))}
                                className="flex-1 bg-white border border-[#D0E8F8] rounded-lg p-2 text-xs outline-none focus:border-[#25D366]"
                            />
                        </div>
                        ...
                        <button onClick={saveWaConfig} className="w-full bg-[#075e54] text-white text-xs font-bold py-3 rounded-xl hover:bg-[#054d44] transition-colors">💾 Simpan Nomor WA</button>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-[#D0E8F8] flex flex-col overflow-hidden">
                    <div className="bg-[#1E5084] p-4 text-white flex justify-between items-center">
                        <div>
                            <div className="text-sm font-bold">🛡️ Admin Query Console</div>
                    ...
                    <div className="p-4 bg-white border-t border-[#D6EFFF] flex gap-2">
                        ...
                        <button 
                            ...
                            className={`px-5 rounded-xl transition-colors text-white ${
