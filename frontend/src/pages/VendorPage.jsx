...
const VendorPage = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            let errorMsg = isEdit ? 'Failed to update vendor' : 'Failed to add vendor';
            ...
            <div className="bg-white p-3 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-3 mb-8 sticky top-0 z-30">
                ...
                <div className="flex items-center space-x-4">
                    <button
                        ...
                        className="bg-[#2174C3] hover:bg-[#1A5E9D] text-white w-36 py-2 rounded-lg font-medium shadow-sm transition-all text-sm cursor-pointer"
                    >
                        Download Report
                    </button>
                    {isAdmin && (
